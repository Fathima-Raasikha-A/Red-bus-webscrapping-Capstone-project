...
# Sidebar Menu
st.sidebar.title("Home")  # Sidebar heading
menu_option = st.sidebar.radio("Main-menu", ["Home Page", "Filtering Page"])  # Sidebar menu

# Home Page
if menu_option == "Home Page":

    # Notes and welcome messages
    st.title("Hey there..!")
